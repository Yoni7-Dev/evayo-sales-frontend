...
export const getSalesBySalesperson = () =>
  api.get("/sales/summary-by-salesperson");
...
export const addEmployeeExpense = (data) =>
  api.post("/employees/expenses", data);
export const updateEmployeeExpense = (id, data) =>
  api.put(`/employees/expenses/${id}`, data);
export const deleteEmployeeExpense = (id) =>
  api.delete(`/employees/expenses/${id}`);
